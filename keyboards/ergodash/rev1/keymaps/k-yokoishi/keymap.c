...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  |      | Space|||||||| Alt  |      |   N  |   M  |   ,  |   .  |   /  | Shift|
   * |-------------+------+------+------+------| SandS|------+------+------| Enter|------+------+------+------+-------------|
   * | Cmd  |  Alt |  Alt | Cmd  ||||||||LW/EIS|      | Shift|||||||| Bspc |      |RS/KAN|||||||| Cmd  | Left | Down | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT_4key_2u_inner( \
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_SPC,                         KC_LALT, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
    KC_ESC,  KC_LALT, KC_LALT, KC_LGUI, LOWER,   SFT_T(KC_SPC), KC_LSFT,                  KC_BSPC, KC_ENT,  RAISE,   KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [_LOWER] = LAYOUT_4key_2u_inner(
    ...
    KC_TAB,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_LBRC,                        KC_RBRC, KC_TILD, KC_GRV,  KC_LBRC, KC_RBRC, KC_P,    KC_BSLS, \
