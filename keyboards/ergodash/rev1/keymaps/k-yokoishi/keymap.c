...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_4key_2u_inner( \
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    _______,                        KC_EQL,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, \
  ...
  [_LOWER] = LAYOUT_4key_2u_inner(
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    _______,                        KC_EQL,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, \
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_LBRC,                        KC_RBRC, KC_Y,    KC_U,    KC_LCBR, KC_RCBR, KC_P,    KC_BSLS, \
    KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    _______,                        KC_SLSH, KC_H,    KC_EQL,  KC_LBRC, KC_RBRC, KC_SCLN, KC_QUOT, \
